...
export default (function() {
    ...
    Vue.filter('dateYM', function(value) {
        let day = moment(value)
        let date = moment(day).format('YYYY年MM月DD日')
        return date
    })
    ...
    Vue.filter('date_format', function(value) {
        ...
        /**
         * 时间格式转化YYYY 年 MM 月 DD 日
         */
    Vue.filter('date_format_ch', function(value) {
        let day = moment(value)
        let date = moment(day).format('YYYY 年 MM 月 DD 日')
        return date
    })
